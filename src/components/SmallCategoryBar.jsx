        ...
        <div>
            <div className='p-3'>
                <div onClick={() => setIsOpen(!isOpen)} className=' cursor-pointer flex gap-4 items-center'>
                    ...
                    <p className='font-semibold'>{pathName.slice(6)}</p>
                </div>

                <div className={`${isOpen ? "flex flex-col gap-2 rounded-md overflow-y-scroll py-4" : "hidden"} `}>
                    <h1 className='bg-[#1FA45B] text-white p-4 text-center lg:hidden'>Categories</h1>
                    <div className='p-3'>
                        {/* categories */}
                                                        ...
                                                        <div className={`space-y-5 mt-5`}>
                                                            ...
                                                            {/* dua */}
                                                            {
                                                                duas.filter(dua => sub.subcat_id === dua.subcat_id).map((singleDua, didx) => (
                                                                    <div onClick={() => setIsOpen(false)} key={didx} className={`ml-5 text-sm ${singleDua.subcat_id === openSubCat ? "block" : "hidden"}`}>
